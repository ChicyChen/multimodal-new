...
save_folder = "/scratch/qingqu_root/qingqu1/siyich/multimodal-gap/3_nw_train_same_checkpoints_learn_5e-4_1e-1"
# step_list = list(range(10,201,50))
step_list = [5000,10000,15000,20000]
# step_list = [1,100,1000,2000,3000,4000]
# step_list = list(range(2000,20000,2000))
